...
class TopologyHVisitor(AbstractVisitor.AbstractVisitor):
    """
    ...
    def __init__(self):
        ...
        DEBUG.info("TopologyHVisitor: Instanced.")
        self.bodytext = ""
        self.prototypetext = ""
    ...
    def _writeTmpl(self, c, visit_str):
        ...
        """
        DEBUG.debug("TopologyHVisitor:%s" % visit_str)
        DEBUG.debug("===================================")
        DEBUG.debug(c)
    ...
    def publicVisit(self, obj):
        ...
        @param args: the instance of the concrete element to operation on.
        """
        c = publicTopologyH.publicTopologyH()
