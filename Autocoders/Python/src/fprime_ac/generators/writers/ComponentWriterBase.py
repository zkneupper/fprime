...
class ComponentWriterBase(AbstractWriter.AbstractWriter):
    """
    ...
    def initBase(self, writer):
        ...
        DEBUG.info("ComponentWriter: Instanced.")
        self.bodytext = ""
        self.prototypetext = ""
    ...
    def initCompIncludePath(self, obj, c):
        ...
        if self.__config.get("includes", "comp_include_path") == "None":
            ...
            c.comp_include_path = self.__config.get(
                "includes", "comp_include_path"
            ).replace("/test/ut", "")
